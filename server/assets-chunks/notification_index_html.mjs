...
</style><link rel="stylesheet" href="styles-24JM3Z6T.css" media="print" onload="this.media='all'"><noscript><link rel="stylesheet" href="styles-24JM3Z6T.css"></noscript><style ng-app-id="ng">.header-div[_ngcontent-ng-c1371857285]{background-color:#ffc300;display:flex;justify-content:space-between;padding:24px 16px;align-items:center}.exit[_ngcontent-ng-c1371857285]   button[_ngcontent-ng-c1371857285]{background-color:transparent;border:none}</style></head>
<body>
  <app-root ng-version="19.2.8" ng-server-context="ssg"><router-outlet></router-outlet><app-notification _nghost-ng-c1371857285><div _ngcontent-ng-c1371857285 class="notif-div"><div _ngcontent-ng-c1371857285 class="top"><div _ngcontent-ng-c1371857285 class="header-div"><div _ngcontent-ng-c1371857285 class="exit"><button _ngcontent-ng-c1371857285 type="button"><img _ngcontent-ng-c1371857285 src="assets/exit.png" alt="exit"></button></div><div _ngcontent-ng-c1371857285 class="header"><h2 _ngcontent-ng-c1371857285><b _ngcontent-ng-c1371857285>Notifications</b></h2></div><div _ngcontent-ng-c1371857285 class="exit" style="opacity: 0;"><button _ngcontent-ng-c1371857285 type="button"><img _ngcontent-ng-c1371857285 src="assets/exit.png" alt="exit"></button></div></div></div><!----><!----></div></app-notification><!----></app-root>
